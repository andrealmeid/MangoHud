...
int gpuLoadLog = 0, cpuLoadLog = 0, log_period = 0, log_write_interval = 0, elapsedLog;
...
const char* log_write_interval_env = std::getenv("LOG_WRITE_INTERVAL");
int num;
bool loggingOn;
uint64_t log_start;
uint64_t last_write = os_time_get();
